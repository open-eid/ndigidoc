...
FileUtils.cp_r "../../NDigiDoc/", "#{source_location}"
...
FileUtils.cd build_directory do
  ...
  FileUtils.cp "#{source_location}/NDigiDoc/packaging/ndigidoc-dev.wxs", "."
  ...
  FileUtils.rm_rf "#{source_location}\\NDigiDoc\\NDigiDoc\\packaging"
