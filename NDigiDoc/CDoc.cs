...
namespace NDigiDoc
{
    public class CDoc
    {
        ...
        private List<KeyValuePair<string, string>> _encryptionProperties;
        /// <summary>
        /// <para>Contains additional information about the CDoc. AutoGenerated unless specified otherwise.</para>
        /// </summary>
        public List<KeyValuePair<string, string>> EncryptionProperties
        {
            get
            {
                if (_encryptionProperties == null)
                {
                    _encryptionProperties = new List<KeyValuePair<string, string>>();
                }
        ...
        protected virtual void GenerateEncryptionProperties(byte[] data, string fileUriOrNull)
        {
            ...
            EncryptionProperties.Add(new KeyValuePair<string, string>(CDoc.ENC_PROP_LIB_VERSION, "NDigiDoc|" + version)); ;
            EncryptionProperties.Add(new KeyValuePair<string, string>(CDoc.ENC_PROP_DOC_FORMAT, "ENCDOC-XML|1.0"));
            ...
            if (fileUriOrNull != null)
            {
                ...
                EncryptionProperties.Add(new KeyValuePair<string, string>(CDoc.ENC_PROP_FILE_NAME, fileName));
                //EncryptionProperties[CDoc.ENC_PROP_ORIG_MIMETYPE] = mimeType;
            }
            EncryptionProperties.Add(new KeyValuePair<string, string>(CDoc.ENC_PROP_ORIG_SIZE, data.Length.ToString()));
        }
        ...
        private void ExtractEncryptionProperties()
        {
            ...
            {
                EncryptionProperties.Add(new KeyValuePair<string,string>(encProp.Attribute("Name").Value, encProp.Value));
            }
        }
