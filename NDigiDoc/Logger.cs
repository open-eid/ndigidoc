...
{
    /// <summary>
    /// Logging proxy. Eliminates the log4net dll dependency for those, who wish not to use it.
    /// </summary>
    internal static class Logger
    {
        private static readonly bool _isLoggingOff = true;
        ...
        internal static ILog CreateLog()
        {
            ...
            return _isLoggingOff ? new NoLog() as ILog : new Log4NetLogger(type);
        }
